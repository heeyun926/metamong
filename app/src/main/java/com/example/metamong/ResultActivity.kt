...
class ResultActivity : AppCompatActivity() {
    ...
    fun loadData(): MutableList<ProfileData> {
        ...
        with(list){
            add(ProfileData(R.drawable.desktop_side,"Programmer","#꼼꼼하고 #응용을 잘하는","논리력 : 현상이나" +
            ...
            add(ProfileData(R.drawable.mobile_side,"UXUI Designer","#꼼꼼하고 #응용을 잘하는","문제해결 능력 : 진정한 문제를" +
